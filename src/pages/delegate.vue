...
body {
  .total-stake {
    ...
    .twins-column--start {
      align-self: center;
      box-shadow: 0px 14px 38px 0px rgba(141, 149, 162, 0.2);
    ...
    .twins-section--start {
      ...
      .copy {
        @include button(lighten($brand-black, 90), $brand-black);
        font-weight: 700;
        display: block;
